                        ...
                        <div className='lg:w-6/12 pb-12'>
                            ...
                            <div className='text-center'>
                                <div className='-rotate-6'>
                                    <p className='rounded-full py-2 px-8 border border-black-100 bg-[#61d2ff] text-outline font-bangers text-[#61d2ff] md:text-6xl text-3xl lg:w-1/2 animate-beat'>
                                        THE STORY
                                    </p>
                                </div>
                            ...
                            <div className='md:space-y-8 space-y-5 mt-8 bg-[#FF5757] text-outline md:text-3xl text-xl font-chewy'>
